    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                <h1 class="page-title">Kasa Listele</h1>
                <div>
                    <ol class="breadcrumb">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td><?= $value["id"] ?></td>
                                                <td><?= $value["name"] ?></td>
                                                <td><a class="btn btn-sm btn-primary" href="<?= \App\Helpers\Helper::route("/cash/edit/{$value['id']}") ?>">Düzenle</a></td>
                                                <td>
                                                    <form method="POST" action="<?= \App\Helpers\Helper::route("/cash/delete") ?>">
